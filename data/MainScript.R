...
# *csv files must be copied in the same folder as this script to be ingested into the current environment
...
# Read in the data
indiv_data <- read_csv("MergedSiteIndivPolys_Zstats_Join.csv")
agg_data <- read_csv("MergedSiteAggregatePolys_Zstats_Join.csv")
...
################################################################################
################### PLANT HEIGHTS ###################
ph_zstat <- read_csv("MergedSiteIndivPolys_PTHT_Zstats.csv")
...
measured_data <- read_csv("MergedSiteIndivPolys_Zstats_join.csv") |>
